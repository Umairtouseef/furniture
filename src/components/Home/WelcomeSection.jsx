...
const WelcomeSection = () => {
  ...
  return (
    <section className="container mx-auto px-6 py-12  lg:mt-0 md:mt-56 mt-96">
      <div className="absolute lg:top-[100vh] left-1/2 transform -translate-x-1/2 w-full max-w-screen-2xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 px-4 gap-6">
          {[ 
            {
              title: "Free Shipping",
              desc: "Save 30%",
            ...
            <div
              key={index}
              className="flex items-center justify-between space-x-4 bg-secondary p-6 text-center relative overflow-hidden group"
            >
              <div className="relative flex-shrink-0 w-30 h-30 overflow-hidden transition-all group-hover:scale-110">
                <img
                  src={feature.image}
                  alt={feature.title}
              ...
              <div className="flex flex-col items-start">
                <h4 className="mb-2 text-white font-bold">{feature.desc}</h4>
                <h3 className="mb-2 text-white font-bold">{feature.title}</h3>
              </div>
      ...
      <div className="text-center sm:mt-64">
